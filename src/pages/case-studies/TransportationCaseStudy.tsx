          ...
          <div className="grid lg:grid-cols-2 gap-14 items-center">
            ...
            <div>
              ...
              <h1 className="font-display text-4xl md:text-6xl font-bold leading-tight mb-6">
                How We Helped a Transportation Company Generate More SEO Leads
              </h1>

              <p className="text-lg text-muted-foreground leading-relaxed mb-8">
                A complete SEO growth strategy that increased rankings,
                inbound traffic, and lead generation for a transportation business.
              </p>
        ...
        <div className="section-container max-w-5xl">
          ...
          <div className="mb-16">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              ...
              competitive transportation market. They needed a scalable
