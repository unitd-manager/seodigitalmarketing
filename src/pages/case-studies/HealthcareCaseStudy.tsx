          ...
          <div className="grid lg:grid-cols-2 gap-14 items-center">
            ...
            <div>
              ...
              <h1 className="font-display text-4xl md:text-6xl font-bold leading-tight mb-6">
                How We Helped a Healthcare Company Increase Patient Leads Through SEO
              </h1>

              <p className="text-lg text-muted-foreground leading-relaxed mb-8">
                A healthcare-focused SEO strategy that improved search visibility, patient inquiries, and appointment bookings.
              </p>
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                <div className="
                    ...
                    ">
                  <h3 className="text-3xl font-bold text-primary">220%</h3>
                ...
                <div className="
                    ...
                    transition-all duration-500
                    ">
                  <h3 className="text-3xl font-bold text-primary">4X</h3>
                  <p className="text-sm text-muted-foreground mt-2">
                    More Leads
                  </p>
                </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="
                ...
                <p className="text-muted-foreground">
                  The website ranked poorly for high-intent healthcare keywords.
                </p>
              </div>
